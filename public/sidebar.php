...
<script>
    $(document).ready(function () {
        //var someVarName = localStorage.getItem("keep");
       // $('#'+txt).css('background', '#21262D');
        var current = "<?php echo $user['menu']; ?>";
         $('#'+current).css('background', '#21262D');
...
<aside id="sidebar-left" class="sidebar-left">
    <div id="menuitem"><?php echo $menu; ?></div>
