...
<html class="fixed">
	<head>
        ...
        $(document).ready(function() {
            $("#send").click(function ()  {
               $.ajax({
                    url: '../resources/views/notification/send.php',
                    type: 'POST',
					...
					<!-- start: page -->
                        <section class="panel">
    						...
    						<div class="panel-body">
    							<form id="fromid" name="formid" action="notification" class="form-horizontal form-bordered" method="post">
    								<div class="form-group">
    									<label class="col-md-3 control-label" for="textareaAutosize">Message content</label>
    									<div class="col-md-6">
    										<textarea class="form-control" rows="4" id="Autosize" name="Autosize" data-plugin-textarea-autosize></textarea>
    									</div>
    								</div>
                                    <div class="form-group">
										<label class="col-md-3 control-label" for="inputSuccess">Device</label>
										<div class="col-md-6">
											<select id="OS" name="OS" class="form-control mb-md">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Message sent</h2>
							</header>
							<div class="panel-body">
