...
<head>
	...
	<title>Porto Admin - Responsive HTML5 Template 1.4.0</title>
...
<body class="documenter-project-porto-admin">
	<div id="documenter_sidebar">
		...
		<ul id="documenter_nav">
			...
			<li><a href="#pushnotification" title="Skin">Push Notification</a></li>
	...
	<h1>Porto Admin</h1>
	<h2>Responsive HTML5 Template 1.4.0</h2>
	...
	<li>latest update: 02/25/2015</li>
	<li>by: Okler Themes</li>
	<li><a href=""></a></li>
	<li>email: <a href="mailto:&#111;&#107;&#108;&#101;&#114;&#64;&#111;&#107;&#108;&#101;&#114;&#46;&#110;&#101;&#116;">&#111;&#107;&#108;&#101;&#114;&#64;&#111;&#107;&#108;&#101;&#114;&#46;&#110;&#101;&#116;</a></li>
	</ul>
	<p>Thank you for purchasing our theme. If you have any questions that are beyond the scope of this help file, please feel free to email via our user page contact form or to our support forum at http://www.okler.net. </p>
	</section>
...
<p class="info">
	...
	<a href="http://www.okler.net">http://www.okler.net</a></p>
<p class="info">
...
<h3>
	&nbsp;</h3>
<h3>
	<strong>CSS Helper Classes</strong></h3>
...
<p>	The file are located at <code>assets/javascripts/theme.js</code><br>
	<br>
	The main theme file contains:</p>
<ul>	<li>		Essential code of the basic structure</li>
...
<p>	You can place here all of your code customization, and also extend the theme plugins.<br>
	This is the safest way to do your customizations and easily theme version without losing your modifications.<br>
	<br>
	Here is an example of theme plugin that you can extend:</p>
<pre class="prettyprint lang-js linenums">
	$.extend(theme.PluginSelect2.defaults, {
		minimumResultsForSearch: -1
	});
</pre>
<p>	Now, by default, all of your select2 plugin will have <code>minimumResultsForSearch</code> set to -1 by default.<br>
...
<p>
	<br>
	You can also customize the background if you&#39;re using the boxed layout.</p>
<p>
	&nbsp;</p>
...
<section id="pushnotification">
	<div class="page-header"><h3>Push Notification</h3><hr class="notop"></div>
<p>	The style switcher was made to support unlimited skin colors, for that we use <strong>Less </strong>(<a href="http://www.lesscss.org/">http://www.lesscss.org/</a>) to process the CSS dinamically in the demo and show the color right away.</p>
<p>	Generate your own skin color using the Preview on ThemeForest:</p>
<p>	<br>
	<img alt="" src="assets/images/image_2.jpg"></p>
<p>	&nbsp;</p>
<p>	You don&#39;t need to use LESS in your project, after you done customizing your skin you may want to grab the generated code and save it in a file (assets/stylesheets/skins/default.css).</p>
...
<section id="effects">
	<div class="page-header"><h3>Effects</h3><hr class="notop"></div>
...
<section id="admin_extension">
	<div class="page-header"><h3>Admin Extension</h3><hr class="notop"></div>
<h3>
	How to integrate Porto Admin Extension on Porto.<br>
	&nbsp;</h3>
<div class="alert alert-info">
	<strong>Warning!</strong> The admin extension is <strong>NOT</strong> included on Porto - Responsive HTML5 Template, to get all features, purchase both templates: <a href="http://www.themeforest.net/item/porto-responsive-html5-template/4106987?ref=Okler" target="_blank">Porto ($15)</a> + <a href="http://www.themeforest.net/item/porto-admin-responsive-html5-template/8539472?ref=Okler" target="_blank">Porto Admin ($23)</a>: <strong>$38 Total.</strong></div>
<p>	&nbsp;</p>
<p>	The Admin Extension is a package with some features from Porto Admin template that can be used in the Front-End (Porto - Responsive HTML5 Template).<br>
	&nbsp;</p>
<p>	- Porto - Responsive HTML5 Template comes with a few samples files, such as feature-admin-charts.html, feature-admin-forms-advanced.html, etc... with those, you can see the HTML Markup and the working pages from the preview.</p>
<p>	<br>
...
<p>	1) Add the CSS files for that specific page (in this example, based on feature-admin-forms-advanced.html):</p>
<p>	<img src="assets/images/image_5.jpg"></p>
<p>	&nbsp;</p>
<p>	(Make sure the paths for the admin match with your own structure, in this example, the path is /admin/...)</p>
<p>	&nbsp;</p>
...
<p>	<img src="assets/images/image_3.jpg"><br>
	&nbsp;</p>
<p>	<strong>SKIN: </strong>If you want to change the color skin, don&#39;t forget to generate the extension skin file and save in the file (assets/stylesheets/skins/extension.css):</p>
