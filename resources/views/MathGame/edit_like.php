        ...
        <section role="main" class="content-body">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form id="fromid" name="formid" action="edit_like" class="form-horizontal form-bordered"
                          method="get">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="textareaAutosize">Status</label>
                            <div class="col-md-6">
                                <textarea class="form-control" rows="1" id="Autosize" name="status"
                                          data-plugin-textarea-autosize><?php echo $status;?></textarea>
                            </div>
                        </div>
