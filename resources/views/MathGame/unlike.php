...
<section class="body">
    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            ...
            <!-- start: page -->
            <form method="get" action="create_unlike">
                <button name="save" class="btn btn-primary">Create Unlike</button>
            </form>
            <br>
            <br>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                        ...
                        <tr class="gradeX">
                            ...
                            <td class="actions">
                                <form method="get" action="unlike_get">
